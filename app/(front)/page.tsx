...
export const metadata: Metadata = {
  title: process.env.NEXT_PUBLIC_APP_NAME || 'Fullstack E-Commercee Store',
  description:
    ...
    <div className='my-8 flex flex-col gap-4 md:gap-16'>
      ...
      <div className='flex flex-col gap-8 md:flex-row'>
        ...
        <div className='flex flex-1 items-center'>
          <div>
            <span className='font-bold'>Trelet Clothing</span> is a gift &
            clothes store based in New Work, <br className='hidden sm:inline' />
            USA. Est since 2009.
          </div>
        </div>
      </div>
